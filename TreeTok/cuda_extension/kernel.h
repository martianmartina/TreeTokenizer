...
void cuda_gather_span_bilm(const at::Tensor & cache_ids, const at::Tensor & spans_batch, TableCell **all_cells, uint **left_most, uint **right_most,
                      uint empty_cache_id, uint beam_size, const at::Tensor & seq_lens, uint bos, uint eos);
...
void cuda_recover_split_cache_ids(const at::Tensor & split_points, const at::Tensor & split_indices, const at::Tensor & split_cache_ids, TableCell ** all_cells, at::Tensor seq_lens);
template <typename T>
...
void cuda_gather_root_ids(const at::Tensor & root_ids, TableCell ** all_cells, uint **right_most);
void cuda_gather2d(const at::Tensor & src, const at::Tensor & index, const at::Tensor & tgt, const at::Tensor & id2batch);